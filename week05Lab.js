...
let myGreeting = new Greeting('Joshua', 'NM')
myGreeting.hello();
...
let yourBook = new Book('Atomic Habits', 'James Clear');
...
class Fruit{
  ...
  describe(){
    return `A ${this.name} is the color ${this.color} and tastes ${this.taste}.`
  }
...
let fruit2 = new Fruit('banana', 'yellow', 'delicious');
...
let movie1 = new Movie('Jurassic Park', 'Steven Speilburg');
